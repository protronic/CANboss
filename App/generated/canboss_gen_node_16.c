...
canboss_node_16_screen_create(void) {
    ...
    canboss_ui_add_bar_row(cont, &canboss_node_16, &canboss_node_16_dps[8]); /* 0x2001.01 Analoge Eingaenge: Eingang 1 */
    canboss_ui_add_bar_row(cont, &canboss_node_16, &canboss_node_16_dps[9]); /* 0x2001.02 Analoge Eingaenge: Eingang 2 */
    canboss_ui_add_bar_row(cont, &canboss_node_16, &canboss_node_16_dps[10]); /* 0x2001.03 Analoge Eingaenge: Eingang 3 */
    canboss_ui_add_bar_row(cont, &canboss_node_16, &canboss_node_16_dps[11]); /* 0x2001.04 Analoge Eingaenge: Eingang 4 */
    canboss_ui_add_value_row(cont, &canboss_node_16, &canboss_node_16_dps[12]); /* 0x2100.00 Temperatur */
    canboss_ui_add_slider_row(cont, &canboss_node_16, &canboss_node_16_dps[13]); /* 0x2101.00 Sollwert */
