 ...
 * 16 Datenpunkte. Neu erzeugen mit: make gen */
...
static const canboss_dp_t canboss_node_16_dps[] = {
    ...
    { .index = 0x2001, .sub = 0x01, .dtype = CB_DT_I16, .access = CB_ACC_RO, .has_limits = 1, .name = "Analoge Eingaenge: Eingang 1", .min = -32768, .max = 32767 },
    { .index = 0x2001, .sub = 0x02, .dtype = CB_DT_I16, .access = CB_ACC_RO, .has_limits = 1, .name = "Analoge Eingaenge: Eingang 2", .min = -32768, .max = 32767 },
    { .index = 0x2001, .sub = 0x03, .dtype = CB_DT_I16, .access = CB_ACC_RO, .has_limits = 1, .name = "Analoge Eingaenge: Eingang 3", .min = -32768, .max = 32767 },
    { .index = 0x2001, .sub = 0x04, .dtype = CB_DT_I16, .access = CB_ACC_RO, .has_limits = 1, .name = "Analoge Eingaenge: Eingang 4", .min = -32768, .max = 32767 },
    { .index = 0x2100, .sub = 0x00, .dtype = CB_DT_F32, .access = CB_ACC_RO, .has_limits = 0, .name = "Temperatur", .min = 0, .max = 0 },
...
canboss_node_16_screen_create(void) {
    ...
    canboss_ui_add_switch_row(cont, &canboss_node_16, &canboss_node_16_dps[4]); /* 0x2000.01 Digitale Ausgaenge: Ausgang 1 */
    canboss_ui_add_switch_row(cont, &canboss_node_16, &canboss_node_16_dps[5]); /* 0x2000.02 Digitale Ausgaenge: Ausgang 2 */
    canboss_ui_add_switch_row(cont, &canboss_node_16, &canboss_node_16_dps[6]); /* 0x2000.03 Digitale Ausgaenge: Ausgang 3 */
    canboss_ui_add_switch_row(cont, &canboss_node_16, &canboss_node_16_dps[7]); /* 0x2000.04 Digitale Ausgaenge: Ausgang 4 */
    canboss_ui_add_value_row(cont, &canboss_node_16, &canboss_node_16_dps[8]); /* 0x2001.01 Analoge Eingaenge: Eingang 1 */
    canboss_ui_add_value_row(cont, &canboss_node_16, &canboss_node_16_dps[9]); /* 0x2001.02 Analoge Eingaenge: Eingang 2 */
    canboss_ui_add_value_row(cont, &canboss_node_16, &canboss_node_16_dps[10]); /* 0x2001.03 Analoge Eingaenge: Eingang 3 */
    canboss_ui_add_value_row(cont, &canboss_node_16, &canboss_node_16_dps[11]); /* 0x2001.04 Analoge Eingaenge: Eingang 4 */
    canboss_ui_add_value_row(cont, &canboss_node_16, &canboss_node_16_dps[12]); /* 0x2100.00 Temperatur */
    canboss_ui_add_spinbox_row(cont, &canboss_node_16, &canboss_node_16_dps[13]); /* 0x2101.00 Sollwert */
    canboss_ui_add_text_row(cont, &canboss_node_16, &canboss_node_16_dps[14]); /* 0x2102.00 Geraetename */
    canboss_ui_add_spinbox_row(cont, &canboss_node_16, &canboss_node_16_dps[15]); /* 0x2103.00 Filterzeit ms */
}
