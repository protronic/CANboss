/* Host-Variante der LVGL-Konfiguration (Linux/SDL2-Build, Makefile.host).
 * Kopie von Middlewares/Third_Party/LVGL/lv_conf.h mit LV_USE_SDL 1 —
 * inhaltliche Aenderungen dort nachziehen. */
/**
 * @file lv_conf.h
