...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.NominalPrescaler = 16;   /* 160 MHz / 16 = 10 MHz */
  hfdcan1.Init.NominalSyncJumpWidth = 4;
  hfdcan1.Init.NominalTimeSeg1 = 15;    /* 20 tq -> 500 kbit/s, SP 80% */
...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  */
  ...
  /* USER CODE BEGIN FDCAN1_MspInit 1 */
    /* FDCAN1 interrupt Init (CANopenNode RX/TX-Benachrichtigungen) */
