...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2110_IO_AnalogeEingaenge = {
        .dataOrig0 = &OD_RAM.x2110_IO_AnalogeEingaenge_sub0,
        .dataOrig = &OD_RAM.x2110_IO_AnalogeEingaenge[0],
        .attribute0 = ODA_SDO_R,
    ...
    .o_2111_IO_Temperatur = {
        .dataOrig = &OD_RAM.x2111_IO_Temperatur,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 4
    },
    .o_2112_IO_DigitaleEingaenge = {
        .dataOrig0 = &OD_RAM.x2112_IO_DigitaleEingaenge_sub0,
        .dataOrig = &OD_RAM.x2112_IO_DigitaleEingaenge[0],
        .attribute0 = ODA_SDO_R,
    ...
    .o_2120_antriebStatus = {
        {
            .dataOrig = &OD_RAM.x2120_antriebStatus.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2120_antriebStatus.statusword,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2120_antriebStatus.drehzahlRampe,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2120_antriebStatus.drehzahlIst,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_2121_antriebMesswerte = {
        {
            .dataOrig = &OD_RAM.x2121_antriebMesswerte.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2121_antriebMesswerte.motorstromMA,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2121_antriebMesswerte.temperaturEndstufe,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_2130_sensorKlima = {
        {
            .dataOrig = &OD_RAM.x2130_sensorKlima.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2130_sensorKlima.temperatur,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2130_sensorKlima.relativeFeuchte,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_2131_sensorUmgebung = {
        {
            .dataOrig = &OD_RAM.x2131_sensorUmgebung.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2131_sensorUmgebung.luftdruckHPa,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2131_sensorUmgebung.messzaehler,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        }
    ...
    .o_2132_sensorAlarm = {
        {
            .dataOrig = &OD_RAM.x2132_sensorAlarm.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2132_sensorAlarm.alarmstatus,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_RPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2132_sensorAlarm.alarmAktiv,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_RPDO,
            .dataLength = 1
        }
    ...
    .o_2210_IO_Kommando = {
        {
            .dataOrig = &OD_RAM.x2210_IO_Kommando.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2210_IO_Kommando.ausgang1,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2210_IO_Kommando.ausgang2,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2210_IO_Kommando.ausgang3,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2210_IO_Kommando.ausgang4,
            .subIndex = 4,
            .attribute = ODA_SDO_RW | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2210_IO_Kommando.sollwert,
            .subIndex = 5,
    ...
    .o_2220_antriebKommando = {
        {
            .dataOrig = &OD_RAM.x2220_antriebKommando.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2220_antriebKommando.controlword,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2220_antriebKommando.drehzahlSollwert,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2220_antriebKommando.bremseAktiv,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_TPDO,
            .dataLength = 1
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x1601, 0x06, ODT_REC, &ODObjs.o_1601_RPDOMappingParameter, NULL},
    ...
    {0x2110, 0x05, ODT_ARR, &ODObjs.o_2110_IO_AnalogeEingaenge, NULL},
    {0x2111, 0x01, ODT_VAR, &ODObjs.o_2111_IO_Temperatur, NULL},
    {0x2112, 0x05, ODT_ARR, &ODObjs.o_2112_IO_DigitaleEingaenge, NULL},
    {0x2120, 0x04, ODT_REC, &ODObjs.o_2120_antriebStatus, NULL},
    {0x2121, 0x03, ODT_REC, &ODObjs.o_2121_antriebMesswerte, NULL},
    {0x2130, 0x03, ODT_REC, &ODObjs.o_2130_sensorKlima, NULL},
    {0x2131, 0x03, ODT_REC, &ODObjs.o_2131_sensorUmgebung, NULL},
    {0x2132, 0x03, ODT_REC, &ODObjs.o_2132_sensorAlarm, NULL},
    {0x2210, 0x06, ODT_REC, &ODObjs.o_2210_IO_Kommando, NULL},
    {0x2220, 0x04, ODT_REC, &ODObjs.o_2220_antriebKommando, NULL},
