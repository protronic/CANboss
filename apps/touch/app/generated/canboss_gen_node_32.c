 ...
 * 15 Datenpunkte. Neu erzeugen mit: make gen */
...
static const canboss_dp_t canboss_node_32_dps[] = {
    ...
    { .index = 0x2202, .sub = 0x00, .dtype = CB_DT_F32, .access = CB_ACC_RO, .has_limits = 1, .name = "Temperatur Endstufe", .min = -2000000, .max = 2000000 },
...
canboss_node_32_screen_create(void) {
    ...
    canboss_ui_add_value_row(cont, &canboss_node_32, &canboss_node_32_dps[3]); /* 0x1009.00 Manufacturer hardware version */
    canboss_ui_add_value_row(cont, &canboss_node_32, &canboss_node_32_dps[4]); /* 0x100A.00 Manufacturer software version */
    canboss_ui_add_value_row(cont, &canboss_node_32, &canboss_node_32_dps[5]); /* 0x2200.00 Motorstrom mA */
    canboss_ui_add_switch_row(cont, &canboss_node_32, &canboss_node_32_dps[6]); /* 0x2201.00 Bremse aktiv */
    canboss_ui_add_value_row(cont, &canboss_node_32, &canboss_node_32_dps[7]); /* 0x2202.00 Temperatur Endstufe */
    canboss_ui_add_spinbox_row(cont, &canboss_node_32, &canboss_node_32_dps[8]); /* 0x6040.00 Controlword */
    canboss_ui_add_value_row(cont, &canboss_node_32, &canboss_node_32_dps[9]); /* 0x6041.00 Statusword */
    canboss_ui_add_spinbox_row(cont, &canboss_node_32, &canboss_node_32_dps[10]); /* 0x6042.00 vl target velocity */
    canboss_ui_add_value_row(cont, &canboss_node_32, &canboss_node_32_dps[11]); /* 0x6043.00 vl velocity demand */
    canboss_ui_add_value_row(cont, &canboss_node_32, &canboss_node_32_dps[12]); /* 0x6044.00 vl velocity actual value */
    canboss_ui_add_spinbox_row(cont, &canboss_node_32, &canboss_node_32_dps[13]); /* 0x6046.01 vl velocity min max amount: vl velocity min amount */
    canboss_ui_add_spinbox_row(cont, &canboss_node_32, &canboss_node_32_dps[14]); /* 0x6046.02 vl velocity min max amount: vl velocity max amount */
}
