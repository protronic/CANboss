...
Netzwerks (einkompiliert ueber `../../tools/eds2tui.py (make gen)`), zeigt sie in einer
...
ZEPHYR_TOOLCHAIN_VARIANT=host west build -b native_sim/native/64 CANboss/apps/monitor
```
...
../../tools/eds2tui.py (make gen)    EDS -> C-Tabellen-Generator
